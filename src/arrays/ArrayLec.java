...
public class ArrayLec {
    ...
    public static void main(String[] args) {
        ...
        String[] words = new String[10]; // using a literal (10) store 10 objects in array
        ...
        int randInt = randomizer.nextInt(4); // generate random number between 0 & 3
        System.out.println(horns[randInt] + " is the best brand!");
        ...
        // Better way to display the first name?
        ...
        // %d ~ "digits", integers and whole numbers
        // %f ~ "floats", decimal numbers. higher precision
